...
public class XiujiashenqingModel  implements Serializable {
	...
	public void setXiujiakaishiriqi(Date xiujiakaishiriqi) {
		this.xiujiakaishiriqi = xiujiakaishiriqi;
	}
	
	/**
	 * 获取：休假开始日期
	 */
	public Date getXiujiakaishiriqi() {
		return xiujiakaishiriqi;
	}
