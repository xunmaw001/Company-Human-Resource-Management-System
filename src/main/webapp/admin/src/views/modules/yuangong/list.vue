<template>
  <div class="main-content">
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('yuangong','考勤登记') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="yuangongkaoqinjiluCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'考勤登记':'' }}</el-button>
                <el-button v-if="isAuth('yuangong','考勤登记') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="yuangongkaoqinjiluCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'考勤登记':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yuangong','考勤登记') && contents.tableBtnIcon == 0" type="success" size="mini" @click="yuangongkaoqinjiluCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'考勤登记':'' }}</el-button>
                <el-button v-if="isAuth('yuangong','人事变更') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="renshibiangengCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'人事变更':'' }}</el-button>
                <el-button v-if="isAuth('yuangong','人事变更') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="renshibiangengCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'人事变更':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yuangong','人事变更') && contents.tableBtnIcon == 0" type="success" size="mini" @click="renshibiangengCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'人事变更':'' }}</el-button>
    ...
    <yuangongkaoqinjilu-cross-add-or-update v-if="yuangongkaoqinjiluCrossAddOrUpdateFlag" :parent="this" ref="yuangongkaoqinjiluCrossaddOrUpdate"></yuangongkaoqinjilu-cross-add-or-update>
    <renshibiangeng-cross-add-or-update v-if="renshibiangengCrossAddOrUpdateFlag" :parent="this" ref="renshibiangengCrossaddOrUpdate"></renshibiangeng-cross-add-or-update>
...
import yuangongkaoqinjiluCrossAddOrUpdate from "../yuangongkaoqinjilu/add-or-update";
import renshibiangengCrossAddOrUpdate from "../renshibiangeng/add-or-update";
export default {
  data() {
    return {
      searchForm: {
      ...
      yuangongkaoqinjiluCrossAddOrUpdateFlag: false,
      renshibiangengCrossAddOrUpdateFlag: false,
  ...
  components: {
    AddOrUpdate,
    yuangongkaoqinjiluCrossAddOrUpdate,
    renshibiangengCrossAddOrUpdate,
  },
  methods: {
    contentStyleChange() {
    ...
    yuangongkaoqinjiluCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.yuangongkaoqinjiluCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','yuangong');
      this.$nextTick(() => {
      this.$refs.yuangongkaoqinjiluCrossaddOrUpdate.init(row.id,type);
      });
    },
    renshibiangengCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.renshibiangengCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','yuangong');
      this.$nextTick(() => {
      this.$refs.renshibiangengCrossaddOrUpdate.init(row.id,type);
      });
    },
    init () {
