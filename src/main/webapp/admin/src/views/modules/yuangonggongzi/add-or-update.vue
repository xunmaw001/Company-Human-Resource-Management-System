<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="基础工资" prop="jichugongzi">
          <el-input v-model="ruleForm.jichugongzi" 
              placeholder="基础工资" clearable  :readonly="ro.jichugongzi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="基础工资" prop="jichugongzi">
              <el-input v-model="ruleForm.jichugongzi" 
                placeholder="基础工资" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="加班补贴" prop="jiabanbutie">
          <el-input v-model="ruleForm.jiabanbutie" 
              placeholder="加班补贴" clearable  :readonly="ro.jiabanbutie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="加班补贴" prop="jiabanbutie">
              <el-input v-model="ruleForm.jiabanbutie" 
                placeholder="加班补贴" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出差津贴" prop="chuchajintie">
          <el-input v-model="ruleForm.chuchajintie" 
              placeholder="出差津贴" clearable  :readonly="ro.chuchajintie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出差津贴" prop="chuchajintie">
              <el-input v-model="ruleForm.chuchajintie" 
                placeholder="出差津贴" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="缺勤天数" prop="queqintianshu">
          <el-select  @change="queqintianshuChange" v-model="ruleForm.queqintianshu" placeholder="请选择缺勤天数">
            <el-option
                v-for="(item,index) in queqintianshuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.queqintianshu" label="缺勤天数" prop="queqintianshu">
              <el-input v-model="ruleForm.queqintianshu" 
                placeholder="缺勤天数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="缺勤扣钱" prop="queqinkouqian">
          <el-input v-model="ruleForm.queqinkouqian" 
              placeholder="缺勤扣钱" clearable  :readonly="ro.queqinkouqian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="缺勤扣钱" prop="queqinkouqian">
              <el-input v-model="ruleForm.queqinkouqian" 
                placeholder="缺勤扣钱" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="实际工资" prop="shijigongzi">
            <el-input v-model="shijigongzi"
                placeholder="实际工资" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shijigongzi" label="实际工资" prop="shijigongzi">
              <el-input v-model="ruleForm.shijigongzi" 
                placeholder="实际工资" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  ...
  computed: {
    shijigongzi: {
      get: function () {
        return 0+parseFloat(this.ruleForm.jichugongzi==""?0:this.ruleForm.jichugongzi)+parseFloat(this.ruleForm.jiabanbutie==""?0:this.ruleForm.jiabanbutie)+parseFloat(this.ruleForm.chuchajintie==""?0:this.ruleForm.chuchajintie)-parseFloat(this.ruleForm.queqinkouqian==""?0:this.ruleForm.queqinkouqian) || 0
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhiwei = true;
          ...
          if(o=='jichugongzi'){
            this.ruleForm.jichugongzi = obj[o];
	    this.ro.jichugongzi = true;
            continue;
          }
          if(o=='jiabanbutie'){
            this.ruleForm.jiabanbutie = obj[o];
	    this.ro.jiabanbutie = true;
            continue;
          }
          if(o=='chuchajintie'){
            this.ruleForm.chuchajintie = obj[o];
	    this.ro.chuchajintie = true;
            continue;
          }
          if(o=='queqintianshu'){
	    ...
	    this.ro.queqintianshu = true;
          ...
          if(o=='queqinkouqian'){
            this.ruleForm.queqinkouqian = obj[o];
	    this.ro.queqinkouqian = true;
            continue;
          }
          if(o=='shijigongzi'){
            this.ruleForm.shijigongzi = obj[o];
	    this.ro.shijigongzi = true;
            continue;
          }
        }
      }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/queqinkouqianbiaozhun/queqintianshu`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.queqintianshuOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    yuangonggonghaoChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
              ...
              if(data.data.queqinkouqian){
                this.ruleForm.queqinkouqian = data.data.queqinkouqian
              }
        } else {
          this.$message.error(data.msg);
        }
    ...
    queqintianshuChange () {
      this.$http({
        url: `follow/queqinkouqianbiaozhun/queqintianshu?columnValue=`+ this.ruleForm.queqintianshu,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.yuangongxingming){
    ...
    onSubmit() {
      ...
      // ${column.compare}
      // ${column.compare}
        this.ruleForm.shijigongzi = this.shijigongzi
