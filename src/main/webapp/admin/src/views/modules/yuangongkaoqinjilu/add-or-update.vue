<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考勤天数" prop="kaoqintianshu">
          <el-input v-model="ruleForm.kaoqintianshu" 
              placeholder="考勤天数" clearable  :readonly="ro.kaoqintianshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考勤天数" prop="kaoqintianshu">
              <el-input v-model="ruleForm.kaoqintianshu" 
                placeholder="考勤天数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="修改时间" prop="xiugaishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.xiugaishijian" 
                type="datetime"
                placeholder="修改时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiugaishijian" label="修改时间" prop="xiugaishijian">
              <el-input v-model="ruleForm.xiugaishijian" 
                placeholder="修改时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.xiugaishijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhiwei = true;
          ...
          if(o=='kaoqintianshu'){
            this.ruleForm.kaoqintianshu = obj[o];
	    this.ro.kaoqintianshu = true;
            continue;
          }
          if(o=='queqincishu'){
	    ...
	    this.ro.queqincishu = true;
          ...
          if(o=='xiugaishijian'){
            this.ruleForm.xiugaishijian = obj[o];
	    this.ro.xiugaishijian = true;
            continue;
          }
        }
      }
    ...
    info(id) {
      this.$http({
        url: `yuangongkaoqinjilu/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yuangongkaoqinjilu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yuangongkaoqinjiluCrossAddOrUpdateFlag = false;
                  this.parent.search();
